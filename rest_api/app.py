...
def inicio():
    if request.method == 'POST':
        restaurante = (request.form.get('restaurante_nome') or '').strip()
        prato = (request.form.get('prato_nome') or '').strip()
        preco = (request.form.get('preco_nome') or '').strip()
        descricao = (request.form.get('descricao_nome') or '').strip()
